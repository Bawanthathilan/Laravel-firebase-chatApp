...
@section('title', 'Start | Laravel Chat')
                        ...
                        <div id="app" class="ui two columns grid cards ">
                            @foreach($users as $user)
                                <div class="card">
                                    ...
                                    <div class="extra content">
                                        <div class="ui">
                                            <a href="{{route('chat', [$user->username])}}" class="ui fluid basic teal button"><i class="talk outline icon"></i> Chat</a>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
