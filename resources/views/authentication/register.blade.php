...
<div id="appRegister" class="ui middle aligned center aligned grid">
  <div class="column">
      ...
      <div class="ui stacked segment">
        ...
        <div class="field">
          <div class="ui left icon input">
            <i class="user icon"></i>
            <input type="text" v-model="registerData.name" placeholder="Name" value="{{old('name')}}">
          </div>
        </div>
        ...
        <div class="field">
          <div class="ui left icon input">
            ...
            <input type="text" v-model="registerData.username" placeholder="Username" value="{{old('username')}}">
          </div>
        </div>
        ...
        <button type="submit" :class="['ui fluid large teal submit button', {'loading': loading}]" :disabled="loading">Enter</button>
    ...
    <div class="ui message">
      Are you already Registered? <a href="{{route('entrar')}}">Log in</a>
    </div>
  </div>
</div>
